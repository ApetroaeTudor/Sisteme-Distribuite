...
<body>
    ...
    <ul type="bullet">
        ...
        <li>Anul nasterii: <% Object anNastere=request.getAttribute("anNastere"); if (anNastere !=null) {
                out.print(anNastere); } else { out.print("necunoscut"); } %>
        </li>
    </ul>
    ...
    <form action="./process-student" method="post">
        Nume:
        <input type="text" name="nume" value="<jsp:getProperty name='studentBean' property='nume' />" />
        <br />

        Prenume:
        <input type="text" name="prenume" value="<jsp:getProperty name='studentBean' property='prenume' />" />
        <br />

        Varsta:
        <input type="number" name="varsta" value="<jsp:getProperty name='studentBean' property='varsta' />" />
        <br /><br />
