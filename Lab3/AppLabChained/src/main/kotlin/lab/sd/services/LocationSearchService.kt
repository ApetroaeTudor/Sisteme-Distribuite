...
@Service
class LocationSearchService(private val m_blacklistFiltering: IBlacklistFiltering) : ILocationSearch, IChainable {
    ...
    override fun progress(dataToSend: String):String  {
        val locationCoords= getLocationCoordinates()
        return m_blacklistFiltering.progress(Json.encodeToString(locationCoords))
    }
}